...
void main() {
  testWidgets('Text.dashronyms wraps strings with tooltip spans',
      (tester) async {
    final registry = AcronymRegistry({'API': 'Application Programming Interface'});
    final widget = const Text('Our (API) is public.')
  ...
  testWidgets('Text.dashronyms preserves existing rich text',
      (tester) async {
